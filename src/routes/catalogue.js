...
// Getting Test
router.get("/catalogue/createCatalogue", async (req, res) => {
  try {
...
// Getting Test
router.get("/catalogue/createDefinition", async (req, res) => {
  try {
...
// Getting Test
router.get("/catalogue/crearUsuarios", async (req, res) => {
  try {
...
// Getting Test
router.get("/catalogue/crearProductos", async (req, res) => {
  try {
...
// Getting Test
router.get("/catalogue/crearVariables", async (req, res) => {
  try {
...
// Getting Test
router.get("/catalogue/crearSettings", async (req, res) => {
  try {
